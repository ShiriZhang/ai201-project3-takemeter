...
**Decision rule:** Assess whether the content of the quote is an evaluation of or
prediction about a person, team, or event.

| Quote type                 | Example                                            | Label     |
| -------------------------- | -------------------------------------------------- | --------- |
| States a personal decision | "Neuer: This is my last tournament"                | `factual` |
